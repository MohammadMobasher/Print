...
{
    [Area("Admin")]
    [ControllerRole("Manage Tasks for admin")]
    public class ManageSubProjectAController : BaseAdminController
    {
        ...
        public ManageSubProjectAController(UsersAccessRepository usersAccessRepository,
        ...
        public async Task<IActionResult> Index(int id, SubProjectSearchViewModel searchModel)
        {
            ...
            var model = await _subProjectRepository.LoadAdminAsyncCount(
                id,
                UserId,
                this.CurrentPage,
                this.PageSize,
